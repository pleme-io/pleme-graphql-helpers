...
rec {
  ...
  rootCrate = rec {
    packageId = "pleme-graphql-helpers";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-graphql" = rec {
        ...
        resolvedDefaultFeatures = [ "dataloader" "default" "dynamic-schema" "email-validator" "fast_chemail" "futures-channel" "graphiql" "handlebars" "lru" "playground" "tempfile" ];
      };
      ...
      "pleme-error" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        sha256 = "026hj3i35rh5827cwqiy2y4cnn47zj7rk9xsrh8i0cnn0m2vmpx1";
        libName = "pleme_error";
        dependencies = [
          {
            name = "thiserror";
      ...
      "pleme-graphql-helpers" = rec {
        crateName = "pleme-graphql-helpers";
        version = "0.1.2";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./.; };
        libName = "pleme_graphql_helpers";
        dependencies = [
          {
            name = "async-graphql";
      ...
      "pleme-rbac" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        sha256 = "1y0acqg1mngap264h2sl37gmg0g4c9xc00rfrzks38a6m0zw0pvq";
        libName = "pleme_rbac";
        dependencies = [
          {
            name = "chrono";
